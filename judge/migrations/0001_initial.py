    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(choices=[(0, 'ESTRUTURAS SEQUENCIAIS E CONDICIONAIS'), (1, 'MODULARIZAÇÃO'), (2, 'ESTRUTURAS CONDICIONAIS E DE REPETIÇÃO'), (4, 'VETORES')], max_length=60, verbose_name='Assunto')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='QuestionListApplication',
            fields=[
                ('strasmodelname_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='judge.strasmodelname')),
                ('start_date', models.DateTimeField(verbose_name='Data de Início')),
                ('due_date', models.DateTimeField(verbose_name='Data de Término')),
                ('course_class', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='applications', to='judge.courseclass', verbose_name='Turma')),
                ('question_list', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='applications', to='judge.questionlist', verbose_name='Lista de Exercícios')),
            ],
            options={
