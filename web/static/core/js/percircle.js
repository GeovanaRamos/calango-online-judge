!function (t) {
    ...
    t.fn.percircle = function (e) {
        ...
        return this.each(function () {
            ...
            var i = s.attr("data-percent") || e.percent || 0, c = s.attr("data-perclock") || e.perclock || 0,
            ...
            if (i) {
                ...
                var e = new Date, r = a(e.getHours()) + ":" + a(e.getMinutes()) + ":" + a(e.getSeconds());
    ...
    var r = function (e, r, a) {
        ...
        var c = e.attr("data-secs") || r.secs, l = e.attr("data-timeUpText") || r.timeUpText,
